    ...
    <section class="min-h-[calc(100vh-4.5rem)] bg-sand-50 px-4 py-10 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-6xl">
            ...
            <div class="mt-8 grid gap-5 md:grid-cols-3">
                ...
                <article class="rounded-3xl bg-white p-6 surface-shadow"><span class="grid size-11 place-items-center rounded-2xl bg-brand-50 text-xl text-brand-700">★</span><h2 class="mt-5 text-xl font-black text-ink-950">التقييمات</h2><p class="mt-2 text-sm leading-6 text-slate-500">مراجعة التقييمات ستكون المرحلة التالية.</p></article>
            </div>
        </div>
    </section>
@endsection
